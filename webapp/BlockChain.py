...
# Account information
account_1 = web3.to_checksum_address("0x4d7C54086a691D162730965Fd23aa86741701C27")  # Update with your Ganache account address
...
if not web3.is_connected():
    print("Failed to connect to Ganache. Make sure Ganache is running on", ganache_url)
    web3 = None
    account_1 = None
    private_key = None
...
def compile_contract():
    ...
    contract_path = r"F:\MY_PROJECTS\Drug Traceability\DrugTrace\contracts\DataStorage.sol"
